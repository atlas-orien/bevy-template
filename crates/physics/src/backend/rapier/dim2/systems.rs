...
use crate::{
    ...
    PhysicsMaterial, PhysicsRigidBody, PhysicsSensor, PhysicsVelocity2d,
};
...
pub fn sync_physics_velocities(
    mut commands: Commands,
    velocities: Query<(Entity, &PhysicsVelocity2d), Synced<PhysicsVelocity2d>>,
...
pub fn sync_physics_angular_velocities(
    mut commands: Commands,
    velocities: Query<(Entity, &PhysicsAngularVelocity2d), Synced<PhysicsAngularVelocity2d>>,
    existing_velocities: Query<&RapierVelocity>,
) {
